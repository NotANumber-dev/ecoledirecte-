...
document.body.style.backgroundColor = '#000000';
    ...
    var results = await Promise.all([notesPromise, devoirsPromise, espacePromise, carnetPromise, vieScolairePromise]);
...
function formatDifference(diff) {
  ...
  return '0.00';
    ...
    function renderVieScolaire() {
      ...
      if (absences.length === 0 && retards.length === 0 && punitions.length === 0 && encouragements.length === 0) {
    ...
    widget.innerHTML = `
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .home-card { background: #1C1C2E; border-radius: 20px; padding: 22px; }

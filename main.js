   ...
   try {
     ...
     document.body.style.backgroundColor = '#000000';
       ...
       function showExpiredPopup() {
         alert("SESSION EXPIREE\n\nVeuillez vous reconnecter sur le site officiel d'EcoleDirecte (ecoledirecte.com) au moins une fois, puis relancez le raccourci.");
       }
       ...
       const autoTokenEnabled = localStorage.getItem('ed_autoToken') !== 'false';
       ...
       if (autoTokenEnabled) {
         ...
         if (savedToken && savedToken.token) {
           ...
           if (isValid) {
             ...
             clearLocalToken();
             showExpiredPopup();
             throw new Error("TOKEN_EXPIRED_NEED_RELOGIN");
           }
         }
       }
       ...
       if (!tok || !id) {
         showExpiredPopup();
         throw new Error("AUCUN_TOKEN_VALIDE");
       }
       ...
       cont.innerHTML = html;
               ...
               function nouvo() {
                 ...
                 if (!seenVersion || parseInt(seenVersion) < currentVersion) {
                   alert("TOKENS" + currentVersion + "\n\n• Token sauvegardé automatiquement\n• desactive dans les parametres si tu ne le shouaite pas\n• un token dure 30min-1h. peut etre executé sans reconnexion a chaque fois");
               ...
               function param() {
                 ...
                 var autoToken = document.getElementById('autoTokenToggle').checked;
                 localStorage.setItem('ed_autoToken', autoToken);

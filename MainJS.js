(async () => {
  try {
    ...
    console.log('Démarrage ultra-rapide pour test...');
          ...
          <div class="home-hero">
            <div class="hero-copy">
              ...
              <div class="title-container">
                <h1>EcoleDirecte</h1>
                <span class="dash-animated">-</span>
              </div>
            </div>
            <div class="hero-card">
              <div class="hero-stats"><span>Chargement...</span><strong>...</strong></div>
              <div class="hero-stats"><span>Moyenne générale</span><strong>...</strong></div>
            </div>
          </div>
        </div>
      </div>
        ...
        if (allTasks.length > 0) {
          ...
          for (var i = 0; i < allTasks.length; i++) {
            ...
            if (hasDocs) {
              ...
              html += '<span>📎 Pièces jointes disponibles</span>';
              html += '</div>';
            }
    ...
    widget.innerHTML = `
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .home-hero { display: flex; flex-direction: row; background: #15152B; padding: 32px; border-radius: 24px; margin-bottom: 28px; align-items: flex-start; justify-content: space-between; min-height: 200px; }
        ...
        .home-hero p { color: #B3B3D2; line-height: 1.7; }
    ...
    function setTab(tab) {
      ...
      if (trimesterSelector) trimesterSelector.style.display = tab === "moyennes" ? 'block' : 'none';
      renderContent();
    }
